...
@section('content')
    <div class="row g-4">
        ...
        <div class="col-12">
            <!-- Counter START -->
            <div class="row g-4">
                <h4>پنل مدیریت {{config('app.name')}}</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center position-relative">
                                <img class="w-60 rounded" src="{{asset('assets/images/blog/1by1/01.jpg')}}" alt="product">
                                <div class="ms-3">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center position-relative">
                                <img class="w-60 rounded" src="{{asset('assets/images/blog/1by1/02.jpg')}}" alt="product">
                                <div class="ms-3">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center position-relative">
                                <img class="w-60 rounded" src="{{asset('assets/images/blog/1by1/03.jpg')}}" alt="product">
                                <div class="ms-3">
