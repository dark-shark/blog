    ...
    <div class="container">
        ...
        <div class="row pt-5">
            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                ...
                <div class="row g-2">
                    <div class="col">
                        <a href="#"><img class="w-100" src="{{asset('assets/images/app-store.svg')}}" alt="app-store"></a>
                    </div>
                    <div class="col">
                        <a href="#"><img class="w-100" src="{{asset('assets/images/google-play.svg')}}" alt="google-play"></a>
                    </div>
                </div>
            </div>
        </div>
